    ...
    switch (api) {
        ...
        case "autoridades":
            switch (location.hostname) {
                case "localhost":
                    // Para desarrollo
                    autoridades_plataforma_web_api_url = "http://localhost:8001/autoridades?distrito_id=" + id + '&con_notarias=true';
                    break;
                case "127.0.0.1":
                    // Para desarrollo
                    autoridades_plataforma_web_api_url = "http://127.0.0.1:8001/autoridades?distrito_id=" + id + '&con_notarias=true';
                    break;
                case "172.30.37.233":
                    // Para desarrollo
                ...
                default:
                    // Para producción
                    autoridades_plataforma_web_api_url = "https://plataforma-web-api.justiciadigital.gob.mx/autoridades?distrito_id=" + id + '&con_notarias=true';
            }
            break;
        case "listas":
            switch (location.hostname) {
                case "localhost":
                    // Para desarrollo
                    edictos_plataforma_web_api_url = "http://localhost:8001/edictos?autoridad_id=" + id + '&ano=' + anio;
                    break;
                case "127.0.0.1":
                    // Para desarrollo
                    edictos_plataforma_web_api_url = "http://127.0.0.1:8001/edictos?autoridad_id=" + id + '&ano=' + anio;
                    break;
                case "172.30.37.233":
                    // Para desarrollo
                ...
                default:
                    // Para producción
                    edictos_plataforma_web_api_url = "https://plataforma-web-api.justiciadigital.gob.mx/edictos?autoridad_id=" + id + '&ano=' + anio;
            }
            break;
    }
