    ...
    switch (api) {
        ...
        case "listas":
            switch (location.hostname) {
                case "localhost":
                    // Para desarrollo
                    listas_plataforma_web_api_url = "http://localhost:8001/listas_de_acuerdos?autoridad_id=" + id + '&ano=' + anio;
                    break;
                case "127.0.0.1":
                    // Para desarrollo
                    listas_plataforma_web_api_url = "http://127.0.0.1:8001/listas_de_acuerdos?autoridad_id=" + id + '&ano=' + anio;
                    break;
                case "172.30.37.233":
                    // Para desarrollo
                ...
                default:
                    // Para producción
                    listas_plataforma_web_api_url = "https://plataforma-web-api.justiciadigital.gob.mx/listas_de_acuerdos?autoridad_id=" + id + '&ano=' + anio;
            }
            break;
    }
}
